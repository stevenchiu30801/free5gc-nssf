 ...
 * @param nssfEventNotification Notification about updates to NSSAI availability information
*/

func (a *NotificationApiService) NotificationPost(ctx context.Context, nssfEventNotification NssfEventNotification) (*http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &nssfEventNotification
